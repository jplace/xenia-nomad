...
<div class="min-h-screen flex flex-col">
  <${Container} moreClasses="home-hero md:border-gray md:border-l md:border-r bg-soft-black overflow-hidden">
  <div class="home-hero_container">
    <div class="home-hero_menu">
      ...
      <ul class="home-hero_menu_ul">
        ...
        <li class="inline-block text-lg menu-item">
          <a class="no-underline" href="https://www.instagram.com/_adventurebitch/"
            >INSTAGRAM</a>
        </li>
      </ul>
    </div>
    ...
    <h1 class="home-hero_text"><a class="no-underline" href="/">Adventure Bitch</a></h1>  
  </div>
  <//>
  <${Container} moreClasses="flex-grow px-8 pt-6 pb-8 text-black border-gray border-l border-r bg-white">
    ${children}
  <//>
  <${Container} moreClasses="px-4 py-4 text-center border-gray border-l border-r footer-bg">
